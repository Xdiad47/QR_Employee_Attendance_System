...
if(isset($_SESSION['adminstrative']) || isset($_GET['employee'])){
	...
	$select_employee_id="select * from designation where emp_id=$e_id";
	  ...
	  <div class="row justify-content-center" >
        <div class="col-md-6">
          <div class="clearfix">
            ...
            <a class="btn btn-warning btn-big"  href="scans.php">Scan Your Code First</a>
          </div>
    ...
    <div class="row justify-content-center" >
        <div class="col-md-6">
          <div class="clearfix">
            ...
            <p class="text-muted">Employee Didnt Match</p>
            <a class="btn btn-warning btn-big"  href="scans.php">Scan Again</a>
          </div>
  ...
  <div class="col-md-3 col-sm-3">
        ...
        <div class="col-md-6">
          <div class="clearfix">
            ...
            <h4 class="pt-3">Un-Authorized Access</h4>
            <p class="text-muted">Access to this page is forbidden</p>
            <a class="btn btn-warning btn-big"  href="scans.php">Please Try Again</a>
          </div>
