	...
	<table class="table table-responsive-sm table-bordered table-striped table-sm " id="tblCustomers" cellspacing="0" cellpadding="0">
	  ...
	  <tbody>
		...
		<tr>
			...
			<td style="width:20%"><?php echo $row['emp_time_out']; ?></td>
			<td style="width:20%"><?php echo $row['atten_date']; ?></td>
        ...
        $("body").on("click", "#btnExport", function () {
            html2canvas($('#tblCustomers')[0], {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("<?php echo $row['applicant_name'];?>.pdf");
                }
            });
        });
    </script>
